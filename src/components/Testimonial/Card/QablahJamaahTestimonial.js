        ...
        <div className='h-[1575px]'>
            ...
            <div className='mx-[100px]'>
                <div className="grid grid-cols-2">
                    ...
                    <div className='bg-[#D19B56]' style={{borderRadius:'0px 10px 10px 0px'}}>
                        <div className='text-white'>
                            <div className=' mx-8 mt-8'>
                                <div className='flex justify-start mb-4'>
                                    <div className='h-[85px] w-[85px] bg-[#BDBDBD] rounded-full inline-block border-[3px] border-solid border-white'></div>
                                    <div className='ml-4'>
                                        <p className='text-[18px] Gothic-A1-700 '>Aisha Hassan</p>
                                        <p className='Gothic-A1-600 text-[12px]  text-left'>Nurse</p>
                            ...
                            <div className='text-left'>
                                <h3 className='scheherazade-thin text-[32px] ml-8'>Qabla exceeded expectations!</h3>
                                <p className='Gothic-A1-400 px-4 py-2 mx-8 rounded-lg  bg-[#0303037e]'> Every aspect of our journey was handled with utmost professionalism. From the moment we arrived until our return, the team ensured our comfort and safety.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='mx-[100px] mt-10'>
                <div className="grid grid-cols-3 gap-8">
                    <div className='h-[325px] border-[1px] border-solid border-[#E5E5E5]        rounded-lg'>
                        <div className=' mx-8 mt-8'>
                            <div className='flex justify-start mb-4'>
                                <div className='h-[85px] w-[85px] bg-[#BDBDBD] rounded-full inline-block border-[3px] border-solid border-[#D19B56]'></div>
                                <div className='ml-4'>
                        ...
                        <div className='text-left'>
                            <h3 className='scheherazade-thin text-[32px] ml-8'>Great customer service!</h3>
