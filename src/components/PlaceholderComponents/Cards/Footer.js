...
const Footer = () => {
    return (
        <div className='bg-black'>
            <div className='w-1440px mt-10 h-[828px] text-white'>
                <div className="grid grid-cols-3 gap-4 mx-[140px]">
                    <div className='mt-[85px] w-[293px] text-left'>
                        ...
                        <p className='Gothic-A1-400 mt-6'>Reflections on the significance of each ritual, immerse yourself in the richness of this spiritual endeavor and shape it to align perfectly with your intentions and aspirations</p>
                    </div>
